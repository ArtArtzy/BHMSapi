...
$files = array_diff(scandir("data",SCANDIR_SORT_DESCENDING), array('..', '.')); // folder ทั้งหมด
...
function readText($fileName,$db){
 
   // echo $fileName;
   // echo "<BR>";
   //ทำการ extract file เพื่อหา timestamp
...
$datemap = $yearx . "-" . $monthx . "-" . $datex;
 ...
 if($hourx>=6 && $hourx<=18){
   ...
   // echo $timestmap;
   // echo "<br>";
   //read file หาค่า max min avg ในแต่ละแถว
